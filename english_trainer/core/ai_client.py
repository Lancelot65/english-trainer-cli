...
class AIClient:
    ...
    def _prepare_messages(self, messages: List[Dict[str, str]]) -> List[Dict[str, str]]:
        ...
        systems = [m["content"] for m in msgs if m.get("role") == "system" and m.get("content")]
    ...
    def call(
        ...
        *,
        ...
        try:
            ...
            raise AIClientError(error_handler.handle_ai_error(e))
    ...
    def call_json(
        ...
        *,
        ...
        error_handler.logger.debug(f"Raw AI response: {repr(response)}")
        ...
        if parsed is None:
            ...
            raise AIClientError(f"Invalid JSON response. Response preview: {response_preview}")
