...
class InputValidator(Validator):
    ...
    def __init__(self, validation_func: Optional[Callable[[str], bool]] = None, error_message: str = "Invalid input"):
...
class ModernInputHandler:
    ...
    def prompt(
        ...
        try:
            ...
            input_validator = InputValidator(validator, error_message) if validator else None
